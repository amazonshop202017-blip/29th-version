        ...
        <div className="bg-card rounded-2xl shadow-xl w-full max-w-[520px] pointer-events-auto" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="px-7 pb-6 space-y-5">
            <div>
              ...
              <div className="flex items-center justify-between w-full border border-border rounded-lg px-4 py-3 bg-card cursor-pointer hover:border-foreground/30 transition-colors">
            ...
            <div>
              ...
              <div className="flex items-center w-full border border-border rounded-lg px-4 py-3 bg-card">
                <span className="text-sm text-muted-foreground">$</span>
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-primary mb-1.5">Date</label>
              <div className="flex items-center justify-between w-full border border-border rounded-lg px-4 py-3 bg-card">
