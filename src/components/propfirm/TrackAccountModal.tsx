...
import { X, Search, ChevronDown, ChevronUp, Settings, ArrowRight, Check } from "lucide-react";
...
import { AppDatePickerString } from "@/components/ui/app-date-pickers";
          ...
          <div className="flex flex-1 min-h-0 transition-transform duration-300 ease-in-out" style={{ width: "200%", transform: showEditRules ? "translateX(-50%)" : "translateX(0)" }}>
            ...
            <div className="w-1/2 flex flex-col min-h-0">
              ...
              <div className="flex-1 overflow-y-auto px-7 py-5 space-y-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-sm font-medium text-foreground mb-1.5">Start date <span className="text-rose-500">*</span></label>
                    <AppDatePickerString value={startDate} onChange={setStartDate} />
                  </div>
